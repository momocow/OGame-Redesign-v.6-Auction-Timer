...
gulp.task('dist', gulp.parallel('meta', gulp.series('build', gulp.parallel(distDev, distProd))))
gulp.task('dist:prod', gulp.parallel('meta', gulp.series('build', distProd)))
gulp.task('dist:dev', gulp.parallel('meta', gulp.series('build', distDev)))
